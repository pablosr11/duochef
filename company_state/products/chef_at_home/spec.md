...
## Product principles
- **Engine First, Content Second**: Prioritize building the interactive lesson engine and progress tracking systems over adding many recipes. We need a functional app before a library of content.
- **Safe first**: kitchen safety and food safety are explicit milestones.
- **Functional Stability over Content Volume**: (Current Priority) We have sufficient lesson content for our vertical slice. We must now prioritize making the app and website fully functional over adding more lessons.
- **Deployment over Content**: (Alpha Goal) A live, testable app and website are required by March 8th. No new content (lessons) should be added until these are fully functional.
- **Small wins**: lessons are short; every lesson produces something tangible or a measurable improvement.
- **Skills > recipes**: teach transferable techniques (boil, sauté, season, taste-adjust) before complex dishes.
- **Milestones + gates**: users unlock new levels only after demonstrating basics.
